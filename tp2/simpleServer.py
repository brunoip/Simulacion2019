   ...
   # time_next_event = []
    ...
    def arrive(self):
        ...
        if self.server_status == self.BUSY:
            ...
            Client().registerSecondDepartureTime(self.time, departureTime, "a")
    ...
    def depart(self):
        ...
        if self.num_in_q == 0:
            ...
            Client().registerSecondDepartureTime(self.time_arrival[len(self.time_arrival) - 1], departureTime, "d")
